...
func NewNameServiceApp(logger log.Logger, db dbm.DB,baseAppOptions ...func(*bam.BaseApp)) *nameServiceApp {
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, orgstore.StoreKey)
	...
	app.nsKeeper = orgstore.NewKeeper(
		app.bankKeeper,
	...
	app.mm = module.NewManager(
		...
		orgstore.NewAppModule(app.nsKeeper, app.bankKeeper),
